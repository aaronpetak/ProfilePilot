...
#
# Shared across all Linux distros (Debian/Ubuntu and Fedora/RHEL). Distro-
# specific blocks below are guarded by file/executable tests, so this single
# file works unchanged on both families.
